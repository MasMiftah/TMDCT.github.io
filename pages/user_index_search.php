...
<head>
    ...
    <link rel="icon" type="image/png" href="../assets/img/TMDCT_1.png">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by CSNINJAS." data-placement="bottom" target="">
                    TMDCT
                </a>
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/ironman.jpg');">
                ...
                <div class="container">
                    <div class="content-center brand">
                        <img src="../assets/img/TMDCT_1.png" alt="Circle Image" class="rounded-circle">
                        <br><br>
                ...
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="typography-line">
                            <p>
                            Find all the products your heart desires.
                            </p>
                        </div>
                        <br>
